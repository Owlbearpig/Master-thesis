...
\end{equation}
and via a Fourier transform $(\mathcal{F}[\partial_t f(t)] \xrightarrow{} i\omega \mathcal{F}[f(t)](\omega))$ we readily obtain the wave equation in frequency space also known as the Helmholtz equation for $\bm{E}$:
\begin{equation}
    \label{eq:waveeqfreq}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=1]{images/4_chapter04/tikz_e_wave.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=1.1]{images/4_chapter04/tikz_linear_pol.pdf}
...
\subcaptionbox{\label{fig:circ_pol_planewave_a}}
    {\includegraphics[scale=0.8]{images/4_chapter04/tikz_circ_pol_lh.pdf}}
\subcaptionbox{\label{fig:circ_pol_planewave_b}}
    {\includegraphics[scale=0.8]{images/4_chapter04/tikz_circ_pol_rh.pdf}}
...
\begin{table}[h]
    \centering
    \includegraphics[scale=1]{images/4_chapter04/pol_summary_table.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=1.0]{images/4_chapter04/tikz_pol_ellipse.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=1.3]{images/4_chapter04/tikz_phasor_rotation.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=1.30]{images/4_chapter04/tikz_wire_grid_polarizer.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.9]{images/4_chapter04/tikz_electron_shell.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.95]{images/4_chapter04/tikz_calcite_beams.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.73]{images/4_chapter04/tikz_uniaxial_source.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=1.5]{images/4_chapter04/tikz_rytov_derivation.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=2]{images/4_chapter04/tikz_stratified_structure.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=1]{images/4_chapter04/tikz_index_ellipse.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=2.7]{images/4_chapter04/tikz_interface_derivation.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=1.3]{images/4_chapter04/tikz_waveplate_conversions.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=1.63]{images/4_chapter04/tikz_half_waveplate.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=1.55]{images/4_chapter04/tikz_quarter_waveplate.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.9]{images/4_chapter04/tikz_poincare_sphere_intro.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=1]{images/4_chapter04/tikz_frame_rotation.pdf}
...
\begin{table}[H]
    \centering
    \includegraphics[scale=1]{images/4_chapter04/pol_statevectors_table.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=1]{images/4_chapter04/tikz_horizontal_diattenuator.pdf}
...
\begin{table}[h]
    \centering
    \includegraphics[scale=1]{images/4_chapter04/masson_result_table.pdf}
...
\begin{table}[h]
    \centering
    \includegraphics{images/4_chapter04/wu_result_table.pdf}
