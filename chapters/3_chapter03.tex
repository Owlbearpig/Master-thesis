...
\begin{itemize}
    \item Shifts figure
    \item 'derive' waveplate formula
    \item halfwaveplates and quarter waveplates
    \item order of waveplate
    \item Circular Polarizers
    \item Polarization of Polychromatic Light ??
\end{itemize}
