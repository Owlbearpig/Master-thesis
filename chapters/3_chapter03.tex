...
To round off this section of the chapter it is worth mentioning the conventions used here, since some choices might appear arbitrary.
Namings?
The convention used so far
To finish off the section we will talk about the conventions. Tomorrow, again x2 LOL...

\section{Birefringence}
\label{sec:birefringence}[h]
