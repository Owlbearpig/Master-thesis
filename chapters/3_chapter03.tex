...
% TODO page 99 add remark of how reflections and transmittance can be classified as diattenuator in jones calc.
% TODO Note: Rotations are in fact also physically realizable Jones matrices (circular retarders)
% TODO add where its from: works of Gil and Ossikovski collected in book \cite{Lu1994HomogeneousMatrices}
