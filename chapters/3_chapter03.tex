...
The idea of a waveplate or retarder is quite simple. One of the two polarization states of the wave is caused to have its phase evolve faster compared to the other state. Therefore, depending on the distance the wave travels in the waveplate, the amount one component is lagging behind the other can be controlled. With this it is possible to convert any initial polarization state into any other state. 
\begin{itemize}
    \item Shifts figure
