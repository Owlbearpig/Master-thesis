...
As mentioned at the start of this section, the Stokes parameters can be derived directly from observables of the light. Later we will see their relation to the electric field. Each parameter has a filter or polarizer associated with it which transmits and blocks half of the light equally. The filters associated with the four parameters $s_0$ to $s_3$ are a neutral, two linear and a circular polarizer respectively.
TODO
\begin{itemize}
    \item What is a neutral and circular polarizer ??
\end{itemize}
