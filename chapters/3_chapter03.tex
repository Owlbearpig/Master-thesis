...
\label{sec:jonescalc}
The Jones calculus can be used to describe the interaction of polarized light with matter. Specifically, a wide range of non-depolarizing light-matter interactions can be represented by Jones matrices. Evidently, the description is only valid for linear interactions since it is based on a system of linear equations. However, in this section we will limit the description to polarization changes caused by optical elements.
