...
\end{equation}
likewise $\bm{B_1}$ and $\bm{B_2}$ are the magnetic fields in medium one and two respectively. In other words the normal component of the magnetic field is continuous across the interface.
