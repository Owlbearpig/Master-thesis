...
\begin{equation}
    ...
    \partial_x B = \mu_0 \epsilon ik E_z, \; -\partial_z B = \mu_0 \epsilon ik E_x, \; 
...
\begin{equation}
    B = U(z)e^{-iknx},\; E_x = V(z)e^{-iknx},\; E_z = W(z)e^{-iknx},
\end{equation}
which we substitute into equation \ref{eq:rytov_maxwell} to get a set of equations connecting the amplitudes:
\begin{equation}
    \partial_z U = ik \epsilon V,\; -Un = \epsilon W,\; \partial_z V + iknW = -ikn\mu_0 U.
\end{equation}
