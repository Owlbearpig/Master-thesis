...
\begin{equation}
    \epsilon_{e,0} = \frac{a \epsilon_1+b \epsilon_2}{a+b},
    \qquad
    \mu_{e,0} = \frac{a\mu_2+b\mu_1}{\mu_1 \mu_2 (a+b)}
\end{equation}
The cubic term makes the expression more lengthy but it can be determined in the same way:
\begin{equation}
    \epsilon_{e,1} = \epsilon_{e,0} \left(1 + \frac{k^2a^2b^2}{12d^2}\frac{\epsilon_{e,0} \mu^2}{1} \right)
\end{equation}
