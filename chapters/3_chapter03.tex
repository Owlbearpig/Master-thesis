...
Their result can serve as a method of comparison by using the reported birefringence and parameters to approximate the individual Jones matrices. Another similar method is used to 
