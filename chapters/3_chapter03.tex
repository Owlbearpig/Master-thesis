...
\begin{equation}
    ...
    \end{pmatrix}.
\end{equation}
With this description of the setup we can proceed with the derivation of the reflection and transmission coefficients. Respectively, we can represent the incident, reflected and transmitted electric field as follows:
\begin{align}
\begin{split}
...
The boundary conditions on the interface that the tangential components of the electric and magnetic field are continuous, e.i. equations \ref{eq:t_boundary_cond_e} and \ref{eq:t_boundary_cond_b}, requires that
\begin{align}
\begin{split}
...
\begin{split}
    ...
    \bm{E}_{0,i} + \bm{E}_{0,r} = \bm{E}_{0,t}, \\
    \bm{B}_{0,i} + \bm{B}_{0,r} = \bm{B}_{0,t}, \\
\end{split}
\end{align}
...
\end{equation}
it follows that $k_{x,i} = k_{x,r} = k_{x,t} = k = \sqrt{\hat{\epsilon}_{11}}\frac{\omega}{c} = \sqrt{\epsilon_p}\frac{\omega}{c}$. The last two equalities arise from the fact that the rotation is around the x-axis. Equation \ref{eq:lab_epsilon} also shows this. With Faraday's law we can obtain a system of equations relating the electric and magnetic fields of the incident, reflected and transmitted wave:
\begin{equation}
    ...
    \bm{n} \times \bm{B}_t = -\frac{\omega}{k} \hat{\epsilon}_2 \bm{E}_t.
\end{equation}
If we add the first two expressions in equation \ref{eq:some_equation} and use equation \ref{eq:interface_amplitudes} we get:
\begin{equation}
    \bm{n} \times \bm{B}_t = -\frac{\omega}{k}\hat{\epsilon}_1(\bm{E}_{0,i}-\bm{E}_{0,r})
\end{equation}
