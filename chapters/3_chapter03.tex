...
\end{equation}
where $s$ and $p$ indicate the perpendicular and parallel directions respectively. Equations \ref{eq:rytov_2nd_order_final} and \ref{eq:rytov_1st_order_final} are used throughout this work to calculate the birefringence. 
Rest of this section:
- Summary?
- Need to do fig caption below correct.
