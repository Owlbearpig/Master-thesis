...
\label{sec:bf_proof}
shorten a bit and only give outline, fairly boring and not important
...
\label{sec:sellmeier}
Crystalline Quartz values and stuff. values from \cite{DGrischkowsky1990} fitted to third order? 3-terms? sellmeier model
...
Briefly desc. simulation with a picture and how it is evaluated; (anti?)resonance in S21.