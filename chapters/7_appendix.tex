...
\begin{figure}[H]
    \centering
    \includestandalone[scale=0.7]{images/7_appendix/plots/quartz_fits/ri_quartz}
...
\begin{figure}[H]
    \centering
    \includestandalone[scale=0.7]{images/7_appendix/plots/quartz_fits/abs_quartz}
...
\begin{table}[H]
    \centering
    \includestandalone[scale=0.9]{images/7_appendix/sellmeier_parameters_table}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.4]{images/7_appendix/CST.PNG}
...
\begin{figure}[H]
    \centering
    \includestandalone[scale=1.2]{images/7_appendix/plots/cst_sim/bf_sim}
