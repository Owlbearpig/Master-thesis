...
\begin{figure}[H]
    ...
    \subcaptionbox{\label{fig:1}}
        {\hspace*{-2em}\includegraphics[width=0.45\linewidth]{images/setup/Setup-THz-TDS-HHI.pdf}}
    \qquad
    \subcaptionbox{\label{fig:2}}
        {\hspace*{-2em}\includegraphics[width=0.45\linewidth]{images/setup/sample_mount_simple_nosample.pdf}}
