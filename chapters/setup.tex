...
%    \caption{}\label{}
%    \centering\includegraphics[width=0.45\linewidth]{images/setup/Setup-THz-TDS-HHI.pdf}
%    \end{subfigure}%
%    \begin{subfigure}[b]{.5\linewidth}
%    \caption{}\label{}
%    \centering\includegraphics[width=0.45\linewidth]{images/setup/sample_mount_simple_nosample.pdf}
%    \end{subfigure}
