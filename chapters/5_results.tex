...
\begin{figure}[ht]
    \centering
    \includegraphics[scale=0.73]{images/5_chapter05/plots/ceramic/ri_bf.pdf}
...
\begin{figure}[ht]
    \centering
    \includegraphics[scale=3.00]{images/5_chapter05/tikz_wpstack_ceramic.pdf}
...
\begin{table}[ht]
    \centering
    \includegraphics[scale=1.0]{images/5_chapter05/ceramic_result_table.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.78]{images/5_chapter05/plots/ceramic/loss_function.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.8]{images/5_chapter05/plots/ceramic/alpha.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.75]{images/5_chapter05/plots/ceramic/convergence.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.7]{images/5_chapter05/plots/ceramic/pe_cl4_lp.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.6]{images/5_chapter05/plots/ceramic/pe_cl4_cp.pdf}
...
\subcaptionbox{\label{fig:cl4_pol_deg_a}}
    {\hspace*{-2em}\includegraphics[width=0.45\linewidth]{images/5_chapter05/plots/ceramic/polDeg/degCirc.pdf}}
\qquad
\subcaptionbox{\label{fig:cl4_pol_deg_b}}
    {\hspace*{-2em}\includegraphics[width=0.45\linewidth]{images/5_chapter05/plots/ceramic/polDeg/degCircZoom.pdf}}

\subcaptionbox{\label{fig:cl4_pol_deg_c}}
    {\hspace*{-2em}\includegraphics[width=0.45\linewidth]{images/5_chapter05/plots/ceramic/polDeg/degLin.pdf}}
\qquad
\subcaptionbox{\label{fig:cl4_pol_deg_d}}
    {\hspace*{-2em}\includegraphics[width=0.45\linewidth]{images/5_chapter05/plots/ceramic/polDeg/degLinZoom.pdf}}
...
\begin{figure}[ht]
    \centering
    \includegraphics[scale=0.75]{images/5_chapter05/plots/ceramic/intensity.pdf}
...
\begin{figure}[ht]
    \centering
    \includegraphics[scale=0.75]{images/5_chapter05/plots/ceramic/params_dotted.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.75]{images/5_chapter05/plots/ceramic/ret_and_diat.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.75]{images/5_chapter05/plots/ceramic/eigenstate_eccentricity.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.75]{images/5_chapter05/plots/ceramic/eigenstate_azimuths.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.7]{images/5_chapter05/plots/polymer/HIPS_PP_ri.pdf}
...
\begin{table}[ht]
    \centering
    \includegraphics[scale=1.0]{images/5_chapter05/polymer_result_table.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.7]{images/5_chapter05/plots/polymer/effective_ri_bf.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.7]{images/5_chapter05/plots/polymer/pe_lp.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.7]{images/5_chapter05/plots/polymer/intensity.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.7]{images/5_chapter05/plots/polymer/polDeg.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.7]{images/5_chapter05/plots/polymer/ret_and_diat.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.7]{images/5_chapter05/plots/polymer/inhomogeneity_orthogonality.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.7]{images/5_chapter05/plots/polymer/eigenstate_params.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.7]{images/5_chapter05/plots/polymer/params_dotted.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.65]{images/5_chapter05/plots/polymer/measurement_result.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.7]{images/5_chapter05/plots/polymer/measured_amplitude.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.7]{images/5_chapter05/plots/polymer/dimension_errors/delta_width_error.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.7]{images/5_chapter05/plots/polymer/dimension_errors/delta_angle_error.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=.65]{images/5_chapter05/plots/polymer/dimension_errors/ri_stripe_error.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=.7]{images/5_chapter05/plots/polymer/dimension_errors/delta_stripe_error.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=.7]{images/5_chapter05/plots/polymer/CSTvsFormBF.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=.7]{images/5_chapter05/plots/polymer/ri_slim_grating.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=.7]{images/5_chapter05/plots/polymer/delta_gratings_bf.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=.7]{images/5_chapter05/plots/polymer/IntrinsicBF/ri_fullplates.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=.7]{images/5_chapter05/plots/polymer/IntrinsicBF/FullPlates.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=.7]{images/5_chapter05/plots/polymer/IntrinsicBF/FullPlatesWcalc.pdf}
