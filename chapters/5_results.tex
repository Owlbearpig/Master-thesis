...
This could therefore further indicate that it is harder to minimize $L_{\lambda/4}$ compared to minimizing $L_M$.

A quantification of the shape of the ellipses representing the output states given in figure \ref{fig:cl4_pe_cp} can be seen in figure \ref{fig:cl4_pol_deg}, which shows $V_c$ and $V_l$ as a function of frequency for a linear horizontal input. 
...
\caption{Two}\label{fig:cl4_pol_deg}
\end{figure}
...
% TODO Add pic like fig 1 in https://doi.org/10.1364/AO.54.009758
