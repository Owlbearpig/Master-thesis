...
\begin{figure}[H]
    \centering
    \includestandalone[scale=0.7]{images/5_chapter05/plots/polymer/HIPS_PP_ri}
...
\begin{figure}[H]
    \centering
    \includestandalone[scale=0.65]{images/5_chapter05/plots/polymer/measurement_result}
