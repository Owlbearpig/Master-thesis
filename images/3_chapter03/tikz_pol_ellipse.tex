...
%determine perpendicular axis direction for rendering minor axis
    ...
    %draw the x-y plane
    \draw[axis_line, ->] (-1in,0) -- (1.25in,0) node[textlabel,anchor=west]{$x$};
    \draw[axis_line, ->] (0,-0.5in) -- (0,1in) node[textlabel,anchor=south]{$y$};
...
\begin{tikzpicture}
    ...
    \Dimline[(-\Eoxnorm in,-\lowestpnt in)][(\Eoxnorm in,-\lowestpnt in)]['test'];
