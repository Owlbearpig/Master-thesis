...
\draw[<->, >=stealth] (1.5,0,0) node[above] {$x$} -- (-0.5,0,0);
\draw[<->, >=stealth] (0,-0.5,0) -- (0,1.5,0) node[above] {$y$};
\draw[<->, >=stealth] (0,0,7) -- (0,0,-0.75) node[above] {$z$};
...
\node[above right] at (0.8,0.65,1) {$\bm{E}$};
