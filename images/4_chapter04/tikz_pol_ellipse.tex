...
%determine perpendicular axis direction for rendering minor axis
    ...
    %draw the x-y plane
    \draw[axis_line, ->, >=stealth] (-\Eoxnorm in,0) -- (1.2 in,0) node[textlabel,anchor=west]{$x$};
    \draw[axis_line, ->, >=stealth] (0,-\Eoynorm in) -- (0,0.9 in) node[textlabel,anchor=south]{$y$};
    ...
    \draw[object_line,->, >=stealth] (arrow1back) -- (arrow1front);
    \draw[object_line,->, >=stealth] (arrow2back) -- (arrow2front);
