...
\begin{tikzpicture}[x={(1:1cm)},y={(75:1cm)},z={(190:1cm)}]
    ...
    % 3
    \node[red] (abe) at (2.7,0.2) {\scriptsize Slowaxis};
    \draw[] (2.5,-0.75) -- (3,-0.6) -- (3.43,-0.48);
    \draw[->, >=stealth, red] (3,-0.6) -- (3.2,-0.11);
    \pic [draw=blue,text=blue,->,"{\scriptsize $\psi_i$}", angle radius=12, angle eccentricity=1.5, >=stealth] {angle = horiz--orig--printdir};
