...
\pgfplotstableread[col sep=comma]{plot_data/5_chapter05/ceramic/x_cl4_02_15_n6_cp_pe.csv}\mydata

\def\graphArrow#1#2{
    \pgfmathsetmacro{\xcolind}{int(#1)}
    \pgfmathsetmacro{\ycolind}{int(#1+1)}
    
    \pgfplotstablegetelem{6}{[index]\xcolind}\of\mydata
    \pgfmathsetmacro{\xs}{\pgfplotsretval}
    \pgfplotstablegetelem{6}{[index]\ycolind}\of\mydata
    \pgfmathsetmacro{\ys}{\pgfplotsretval}

    \pgfplotstablegetelem{10}{[index]\xcolind}\of\mydata
    \pgfmathsetmacro{\xe}{\pgfplotsretval}
    \pgfplotstablegetelem{10}{[index]\ycolind}\of\mydata
